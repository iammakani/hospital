...
=== Приёмочный тест № 3 (разные варианты ввода команд пользователем) ===
...
=== Приёмочный тест № 4 (случаи ввода пользователем некорректных данных) ===
...
=== Приёмочный тест № 5 (попытка повысить самый высокий статус, которая приводит к выписке пациента) ===
...
=== Приёмочный тест № 6 (попытка повысить самый высокий статус, которая ни к чему не приводит) ===
...
=== Приёмочный тест № 7 (неудачная попытка понизить самый низкий статус) ===
